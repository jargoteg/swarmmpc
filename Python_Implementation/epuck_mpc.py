...
rob_diam = 0.07      # diameter of the robot, 70mm
wheel_radius = 0.041/2   # wheel radius 41 mm
Lx = 0.053/2            # L in J Matrix (half robot x-axis length)
Ly = 0.053/2         # l in J Matrix (half robot y-axis length)
